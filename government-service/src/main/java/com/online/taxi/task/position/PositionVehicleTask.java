...
@Slf4j
public class PositionVehicleTask extends AbstractSupervisionTask {
    @NonNull
    ...
    private JSONObject getJson(PositionDriverDto positionDriverDto, JSONObject data) {
        ...
        jsonObject.put("VehicleRegionCode", positionDriverDto.getCityCode());
    ...
    public boolean execute(Integer id) {
        ...
        return tryComposeData(maxTimes, p -> {
            ...
            ipcType = OTIpcDef.IpcType.positionVehicle;
            try {
